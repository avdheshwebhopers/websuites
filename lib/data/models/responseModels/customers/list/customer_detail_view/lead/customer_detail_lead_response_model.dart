class CustomerDetailLeadResponseModel {
  ...
  CustomerDetailLeadResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    district =
    json['district'] != null ? new District.fromJson(json['district']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.secondaryEmails != null) {
      data['secondary_emails'] =
          this.secondaryEmails!.map((v) =>()).toList();
    }
...
class User {
  ...
  id, this.firstName, this.lastName, this.email, this.mobile, this.address, this.bio, this.profilePic, this.password, this.status, this.rememberToken, this.rememberTokenTime, this.defaultAt, this.createdAt, this.updatedAt, this.deviceId, this.tracking, this.crmCategory, this.
...
Leads({this.id, this.score, this.firstName, this.lastName, this.countryCode, this.mobile, this.mobileWithCountrycode, this.email, this.organization, this.description, this.address, this.city, this.state, this.flag, this.importCustomData, this.queryTime, this.queryType, this.refId, this.leadBuyerEmail, this.leadBuyerName, this.label, this.note, this.gstin, this.websites, this.deleteRemark, this.deadRemark, this.createdAt, this.updatedAt, this.deletedAt, this.oldLead, this.isOldLead, this.facebookLeadgenId, this.latestEnquiryDate, this.leadStatus});
