class LeadActivityLeadTypeResponseModel {
  String? id;
  String? name;
  Null subTypes;
  String? status;
  ...
  LeadActivityLeadTypeResponseModel(
      {this.id,
        this.name,
        this.subTypes,
        this.status,
  ...
  LeadActivityLeadTypeResponseModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
  ...
  static List<LeadActivityLeadTypeResponseModel> fromJsonList(List<dynamic> jsonList) {
    return jsonList.map((json) =>LeadActivityLeadTypeResponseModel.fromJson(json)).toList();
  }
}
