...
class SalesAddProductResponseModel {
  ...
  SalesAddProductResponseModel({this.quantity, this.targetIncentive, this.product, this.id, this.createdAt, this.updatedAt});

  SalesAddProductResponseModel.fromJson(Map<String, dynamic> json) {
    quantity = json['quantity'];
    targetIncentive = json['taregt_incentive'] != null ? new TargetIncentive.fromJson(json['taregt_incentive']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.targetIncentive != null) {
      data['taregt_incentive'] = this.targetIncentive!.toJson();
    }
