...
//   void initState() {
//     super.initState();
//     _pageController = PageController(initialPage: widget.controller?.initialItem ?? 0);
...
//       return _buildWeightedCarousel();
//     }
//     return _buildStandardCarousel();
//   }
//
//   Widget _buildWeightedCarousel() {
//     return LayoutBuilder(
//       builder: (context, constraints) {
//         final totalWeight = widget.flexWeights!.reduce((a, b) => a + b);
...
//             final weight = widget.flexWeights![index % widget.flexWeights!.length];
//             final itemWidth = (maxWidth * weight) / (widget.consumeMaxWeight ? totalWeight : weight);
//
//             return SizedBox(
//               width: itemWidth,
...
//   }
//
//   Widget _buildStandardCarousel() {
//     return PageView.builder(
//       controller: _pageController,
//       onPageChanged: (page) {
//         setState(() => _currentPage = page);
//         widget.controller?.onPageChanged?.call(page);
//       },
//       itemBuilder: (context, index) {
//         return SizedBox(
