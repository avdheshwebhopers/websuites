...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final HomeScreenLeadSourceViewModel _leadSourceController =
      Get.put(HomeScreenLeadSourceViewModel());
  final HomeScreenTransactionsViewmodel _transactionsController =
